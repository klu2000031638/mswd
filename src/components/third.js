// 
import cse from './assets/CSE-BLOCK.jpg'
import eee from './assets/ELECTRICAL-BLOCK.jpg'
import mech from './assets/MECH-BLOCK.jpg'
import bt from './assets/BIO-TECH-BLOCK.jpg'
...
const App = () => {
 ...
 <div style={s1}>
 <div>
 <Button style={s2} variant="outlined" color="territory" onClick={() => changeView(ComputerScience)} >
 {" "}
 CSE{" "}
 </Button>
 <Button
...
>
 ...
 <img src={dept[0].imageUrl} alt="new" width="760" />
